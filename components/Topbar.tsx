      ...
      <div className="flex-1 w-full max-w-2xl ml-12 md:ml-0">
        <div className="relative">
          <input
            ...
            className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#3B82F6] focus:border-transparent transition-all duration-200 text-base"
          />
          <svg
        ...
        <p className="mt-2 text-sm text-gray-500">
          Try searching: "iphone 13 case", "lego", or seller: tech_world_uk
        </p>
      </div>
